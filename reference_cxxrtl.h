// Nathan: If we included this it results in a dependency of hell, so referencing this, we bare metal patched exactly what we needed to make our wasm from yosys2 to work
/*
